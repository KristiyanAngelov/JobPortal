    ...
    public partial class DataBaseInitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkerJobPosts", x => new { x.CandidateId, x.JobPostId });
                    table.ForeignKey(
                        name: "FK_WorkerJobPosts_AspNetUsers_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkerJobPosts_JobPosts_JobPostId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkerJobPosts_JobPostId",
                table: "WorkerJobPosts",
                column: "JobPostId");
        }

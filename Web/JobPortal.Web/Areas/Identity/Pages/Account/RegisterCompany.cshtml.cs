namespace JobPortal.Web.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModelCompany : PageModel
    {
        ...
        private readonly ILogger<RegisterModelCompany> logger;
        private readonly IEmailSender emailSender;

        public RegisterModelCompany(
            UserManager<ApplicationUser> userManager,
            SignInManager<ApplicationUser> signInManager,
            ILogger<RegisterModelCompany> logger,
...
#pragma warning restore SA1201 // Elements should appear in the correct order
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (this.ModelState.IsValid)
            {
                ...
                await this.userManager.AddToRoleAsync(user, GlobalConstants.CompanyRoleName);
                if (result.Succeeded)
                {
